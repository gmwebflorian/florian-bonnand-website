    ...
    <section id="about" className="py-24 bg-[hsl(var(--cream))]">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-[hsl(var(--ocean-deep))]">
            D'ancien vendeur à expert Amazon
          </h2>
        </div>

        {/* Grid image + texte alignés */}
        <div className="grid md:grid-cols-2 gap-12 items-start mb-12">
          ...
          {/* Right: Texte aligné sur l'image */}
        ...
        <div className="max-w-4xl mx-auto text-center pt-8 border-t border-[hsl(var(--ocean-primary))]/20">
          <p className="text-xl md:text-2xl text-[hsl(var(--ocean-primary))] font-semibold italic">
            "Proximité, résultats concrets et vision orientée ROI : voilà ce qui guide mon accompagnement."
          </p>
        </div>
      </div>
    </section>
