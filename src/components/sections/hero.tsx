...
<p className="text-xs sm:text-base md:text-lg italic text-white/90 mb-8 md:mb-12 max-w-3xl mx-auto leading-relaxed animate-fade-in-up">
  Tenir le cap sur Amazon, grâce à une expertise née du terrain
</p>
<h1 className="text-2xl sm:text-5xl md:text-6xl font-bold text-white mb-6 md:mb-12 max-w-5xl mx-auto maritime-text-shadow animate-fade-in">
